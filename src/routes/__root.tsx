...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SİEC DESSİE KURSU — Talebe Paneli" },
      { name: "description", content: "Talebe kıraat ve Kur'an-ı Kerim ilerleme takibi." },
      { name: "theme-color", content: "#0f172a" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "SİEC Talebe" },
      { property: "og:title", content: "SİEC DESSİE KURSU — Talebe Paneli" },
      { property: "og:description", content: "Talebe kıraat ve Kur'an-ı Kerim ilerleme takibi." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "SİEC DESSİE KURSU — Talebe Paneli" },
